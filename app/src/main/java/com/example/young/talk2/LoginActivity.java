...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    LoginBrocastReceiver loginBrocastReceiver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginBrocastReceiver = new LoginBrocastReceiver();
        IntentFilter intentFilter = new IntentFilter();
        intentFilter.addAction("talk2.Login");

        registerReceiver(loginBrocastReceiver, intentFilter);
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        unregisterReceiver(loginBrocastReceiver);
    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            ConnManager.setUsername(mEmail);
            return true;
//            try {
...
//            }
    ...
    private class LoginBrocastReceiver extends BroadcastReceiver {
        @Override
        public void onReceive(Context context, Intent intent) {
            String msg = intent.getStringExtra("broadcast");
            Log.d("LoginBrocastReceiver", "Chat Message: " + msg);
